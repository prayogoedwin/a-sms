<x-layouts.app>
    <div class="mb-6"><h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Tambah Kelas</h1></div>
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 max-w-2xl">
        <form method="POST" action="{{ route('master-data.kelas.store') }}" class="space-y-3">
            @csrf
            <div>
            ...
            <x-forms.input label="Nama Kelas" name="nama_kelas" value="{{ old('nama_kelas') }}" required />
            <div>
